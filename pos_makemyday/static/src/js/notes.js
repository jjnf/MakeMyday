odoo.define('makemyday_makemyday.notes', function (require) {
"use strict";
...
var OrderlineNoteButton = screens.ActionButtonWidget.extend({
    ...
    button_click: function(){
        var line = this.makemyday.get_order().get_selected_orderline();
        if (line) {
...
screens.define_action_button({
    ...
    'condition': function(){
        return this.makemyday.config.iface_orderline_notes;
    },
});
