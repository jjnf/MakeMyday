odoo.define('makemyday_makemyday.splitbill', function (require) {
"use strict";
...
var SplitbillScreenWidget = screens.ScreenWidget.extend({
    ...
    pay: function(order,neworder,splitlines){
        ...
        if(full){
            ...
            this.makemyday.get('orders').add(neworder);
            this.makemyday.set('selectedOrder',neworder);
        }
    },
    show: function(){
        var self = this;
...
gui.define_screen({
    ...
    'condition': function(){ 
        return this.makemyday.config.iface_splitbill;
    },
});
