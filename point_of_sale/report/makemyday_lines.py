...
class makemyday_lines(report_sxw.rml_parse):

    def __init__(self, cr, uid, name, context):
        super(makemyday_lines, self).__init__(cr, uid, name, context=context)
        self.total = 0.0
    ...
    def __taxes__(self, obj):
        self.cr.execute ( " Select acct.name from makemyday_order as po " \
                              " LEFT JOIN makemyday_order_line as pol ON po.id = pol.order_id " \
