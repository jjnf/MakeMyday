...
var PosDB = core.Class.extend({
    name: 'openerp_makemyday_db', //the prefix of the localstorage data
    ...
    category_contains: function(categ_id, product_id) {
        ...
        if (product) {
            var cid = product.makemyday_categ_id[0];
    ...
    add_products: function(products){
        ...
        for(var i = 0, len = products.length; i < len; i++){
            ...
            var categ_id = product.makemyday_categ_id ? product.makemyday_categ_id[0] : this.root_category_id;
    ...
    is_product_in_category: function(category_ids, product_id) {
        ...
        var cat = this.get_product_by_id(product_id).makemyday_categ_id[0];
        while (cat) {
