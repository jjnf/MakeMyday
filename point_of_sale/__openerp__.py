...
* Refund previous sales
    ...
    'data': [
        ...
        'wizard/makemyday_box.xml',
        'wizard/makemyday_confirm.xml',
        'wizard/makemyday_details.xml',
        'wizard/makemyday_discount.xml',
        'wizard/makemyday_open_statement.xml',
        'wizard/makemyday_payment.xml',
        'views/templates.xml',
        'point_of_sale.xml',
        ...
        'report/makemyday_order_report_view.xml',
