...
class account_journal(osv.osv):
    ...
    def search(self, cr, uid, args, offset=0, limit=None, order=None, context=None, count=False):
        if not context:
            context = {}
        session_id = context.get('makemyday_session_id', False) or False
...
class makemyday_make_payment(osv.osv_memory):
    _name = 'makemyday.make.payment'
    ...
    def check(self, cr, uid, ids, context=None):
        ...
        """
        context = context or {}
        order_obj = self.pool.get('makemyday.order')
    ...
    def launch_payment(self, cr, uid, ids, context=None):
        return {
            ...
            'view_type': 'form',
            'view_mode': 'form',
            'res_model': 'makemyday.make.payment',
            'view_id': False,
            'target': 'new',
            'views': False,
